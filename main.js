...
const TagTram15  = tram15
   ...
   .get();
   ///////////// TRAM 12
const TagTram12_1 = tram12_1
   .read(T12T1_A) 
   .read(T12T1_B) 
   .read(T12T1_C)
   .read(T12T1_Status) 
   .get();
const TagTram12_2 = tram12_2
   .read(T12T2_A) 
   .read(T12T2_B) 
   .read(T12T2_C)
   .read(T12T2_Status) 
...
const TagTram14 = tram14
   ...
   .get(); 
  /////////// trạm 9
const TagTram9_1 = tram9_1
  .read(T9T1_A) 
  .read(T9T1_B) 
  .read(T9T1_C)
  .read(T9T1_Status) 
  .get();
const TagTram9_2 = tram9_2
  .read(T9T2_A) 
  .read(T9T2_B) 
  .read(T9T2_C)
  .read(T9T2_Status) 
  .get();
const TagTram9_3 = tram9_3
  .read(T9T3_A) 
  .read(T9T3_B) 
  .read(T9T3_C)
  .read(T9T3_Status) 
  .get();     
const TagTram9_4 = tram9_4
  .read(T9T4_A) 
  .read(T9T4_B) 
  .read(T9T4_C)
  .read(T9T4_Status) 
  .get();       
  ////// TRẠM 3        
const TagTram3_1 = tram3_1
  .read(T3T1_A) 
  .read(T3T1_B) 
  .read(T3T1_C)
  .read(T3T1_Status) 
  .get();             
const TagTram3_2 = tram3_2
  .read(T3T2_A) 
  .read(T3T2_B) 
  .read(T3T2_C)
  .read(T3T2_Status) 
  ...
  .get();   
  //////// TRAM 2
  const TagTram2_1 = tram2_1
  .read(T2T1_A) 
  .read(T2T1_B) 
  .read(T2T1_C)
  .read(T2T1_Status) 
  .get();  
  const TagTram2_2 = tram2_2
  .read(T2T2_A) 
  .read(T2T2_B) 
  .read(T2T2_C)
  .read(T2T2_Status) 
  .get();  
  const TagTram2_3 = tram2_3
  .read(T2T3_A) 
  .read(T2T3_B) 
  .read(T2T3_C)
  .read(T2T3_Status) 
  .get();   
  const TagTram2_4 = tram2_4
  .read(T2T4_A) 
  .read(T2T4_B) 
  .read(T2T4_C)
  .read(T2T4_Status) 
  .get(); 
  //////// TRAM 5
  const TagTram5_1 = tram5_1
  .read(T5T1_A) 
  .read(T5T1_B) 
  .read(T5T1_C)
  .read(T5T1_Status) 
  .get(); 
  const TagTram5_2 = tram5_2
  .read(T5T2_A) 
  .read(T5T2_B) 
  .read(T5T2_C)
  .read(T5T2_Status) 
  .get();      
  const TagTram5_3 = tram5_3
  .read(T5T3_A) 
  .read(T5T3_B) 
  .read(T5T3_C)
  .read(T5T3_Status) 
  .get();      
  const TagTram5_4 = tram5_4
  .read(T5T4_A) 
  .read(T5T4_B) 
  .read(T5T4_C)
  .read(T5T4_Status) 
